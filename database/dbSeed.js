...
sequelize.authenticate()
  ...
  // ON EC2 INSTANCE \COPY "Questions"(id, product_id, question_body, question_date, asker_name, asker_email, reported, question_helpfulness) from '/home/ubuntu/data/questions.csv' DELIMITER ',' CSV HEADER;
  ...
  // ON EC2 INSTANCE \COPY "Answers"(id, question_id, body, date, answerer_name, answerer_email, reported, helpfulness) from '/home/ubuntu/data/answers.csv' DELIMITER ',' CSV HEADER
  ...
  // ON EC2 INSTANCE \COPY "Photos"(id, answer_id, url) from '/home/ubuntu/data/answers_photos.csv' DELIMITER ',' CSV HEADER
